...
function handleSubmit(e, rating, title, setTitle, setRating, addMovie) {
    e.preventDefault()
...
function MovieInputForm(props) {
    ...
    return (
        <form id="add-movie-form" onSubmit={e => { handleSubmit(e, rating, title, setTitle, setRating, props.onAddMovie) }}>
            <fieldset>
